...
AS $$
DECLARE
  project_url TEXT := 'https://rdcfqdoszrkxpcjqhqcg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJkY2ZxZG9zenJreHBjanFocWNnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMzQ1MDQ5NiwiZXhwIjoyMDI5MDI2NDk2fQ.rb_X0XD4i-yznMV_FNcjkQwVsctcXAjqdyh8qT2OLxg'; -- full access needed for http request to storage
